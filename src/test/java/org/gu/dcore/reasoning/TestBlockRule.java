...
public class TestBlockRule extends TestCase {
     ...
     */
    public TestBlockRule( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( TestBlockRule.class );
    }
	...
	public void test1() {
		...
		for(Rule r : P.getRuleSet()) {
			for(BlockRule br : m.getBlockRules(r)) {
